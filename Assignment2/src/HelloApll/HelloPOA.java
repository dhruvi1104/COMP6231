 ...
 implements HelloApll.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("bookEvent", new java.lang.Integer (0));
    ...
    _methods.put ("validUser", new java.lang.Integer (7));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // HelloApll/Hello/bookEvent
       {
       ...
       case 1:  // HelloApll/Hello/getBookingSchedule
       {
         String customerID = in.read_string ();
         String $result = null;
       ...
       case 2:  // HelloApll/Hello/cancelEvent
       {
         String customerID = in.read_string ();
         String eventID = in.read_string ();
         String eventType = in.read_string ();
       ...
       case 3:  // HelloApll/Hello/swapEvent
       {
         String customerID = in.read_string ();
       ...
       case 4:  // HelloApll/Hello/addEvent
       {
         String eventID = in.read_string ();
         String eventType = in.read_string ();
       ...
       case 5:  // HelloApll/Hello/removeEvent
       {
         String eventID = in.read_string ();
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 6:  // HelloApll/Hello/listEventAvailability
       {
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 7:  // HelloApll/Hello/validUser
       {
         String currentUser = in.read_string ();
         String $result = null;
         $result = this.validUser (currentUser);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
